 ...
 * MIME type encountered in a Heritrix crawl.
 *
 * @author Doug Judd
 */
public class CountMimeTypes {
  ...
  public static class MapClass extends MapReduceBase implements Mapper {
      ...
      private Text mimetype = new Text();
	  ...
	  */
	  ...
	  if (hdfsDoc.getContentType() != null) {
	      mimetype.set(hdfsDoc.getContentType());
	      output.collect(mimetype, one);
	  }
      }
  }

  static void printUsage() {
    System.out.println("CountMimeTypes [-m <maps>] <output> <input> [<input> ...]");
    System.exit(1);
  }
  
  /**
   * The main driver for CountMimeTypes map/reduce program.
   * Invoke this method to submit the map/reduce job.
   * @throws IOException When there is communication problems with the 
   *                     job tracker.
   */
  public static void main(String[] args) throws IOException {
    JobConf conf = new JobConf(CountMimeTypes.class);
    conf.setJobName("countmimetypes");
